...
export const RegisterCategory = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const newCategory = { name, description, color, codigo, videos };

    fetch(
      "https://my-json-server.typicode.com/carloseduardovdeoliveira/aluraflix-api/categories",
      {
        method: "POST",
        headers: {
      ...
      .then((data) => {
        ...
        const updatedCategories = [...categoryState, data];
