...
export const RegisterCategory = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://my-json-server.typicode.com/carloseduardovdeoliveira/aluraflix/categories", {
    method: 'POST',
    headers: {
  ...
  return (
    <div className={styles.container}>
      <form onSubmit={handleSubmit}>
        ...
        <Input value="#000000" onChange={(event) => setColor(event.target.value)} type="color" placeholder="Cor" label={"cor"} />
