...
export const RegisterVideo = () => {
  ...
  useEffect(()=>{
    ...
    .then(res => res.json())
    .then(data=> setVideosState(prevVideos => [...prevVideos, data]))
  },[video])
  ...
  return (
    <form onSubmit={
          (event) => {
            ...
            setVideo({title: name, videoLink: link, thumbnail, category, description, codigo: id})
            setVideosState([...videosState, video])
          } 
        }
